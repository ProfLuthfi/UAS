...
<body>
    <div class="container">
        ...
        <h1 class="mt-4 mb-4 text-center text-danger"> Data SEKOLAH User</h1>
                ...
                <form method="post" id="sample_form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="jurusan" id="jurusan" class="form-control" />
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sample_form').on('submit', function(event) {
                ...
                if ($('#action').val() == "Add") {
                    ...
                    $.ajax({
                        url: "http://localhost/wpnr/oop/api/sekolah/createsekolah.php",
                        method: "POST",
                    ...
                    $.ajax({
                        url: "http://localhost/wpnr/oop/api/sekolah/updatesekolah.php",
                        method: "PUT",
                        data: JSON.stringify(formData),
                        success: function(data) {
                            $('#action_button').attr('disabled', false);
        ...
        function showAll() {
            $.ajax({
                ...
                url: "http://localhost/wpnr/oop/api/sekolah/readsekolah.php",
        ...
        function showOne(id) {
            ...
            $.ajax({
                type: "GET",
                contentType: "application/json",
                url: "http://localhost/wpnr/oop/api/sekolah/readsekolah.php?id=" + id,
                success: function(response) {
        ...
        function deleteOne(id) {
            ...
            $.ajax({
                url: "http://localhost/wpnr/oop/api/sekolah/deletesekolah.php",
                method: "DELETE",
                data: JSON.stringify({
                    "id_sekolah": id
                }),
